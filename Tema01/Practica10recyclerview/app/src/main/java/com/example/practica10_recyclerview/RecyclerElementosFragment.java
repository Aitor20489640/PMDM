...
import com.example.practica10_recyclerview.databinding.FragmentRecyclerElementosBinding;
import com.example.practica10_recyclerview.databinding.ViewholderElementoBinding;
...
public class RecyclerElementosFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.irANuevoElemento.setOnClickListener(v -> navController.navigate(R.id.action_recyclerElementosFragment_to_nuevoElementoFragment));
        ...
        elementosViewModel.obtener().observe(getViewLifecycleOwner(), elementosAdapter::establecerLista);
