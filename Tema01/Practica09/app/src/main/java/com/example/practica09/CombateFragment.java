...
import com.example.practica09.databinding.FragmentCombateBinding;
...
public class CombateFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.lblAtkP1.setText(String.valueOf(pokemon1.getAtk()));
        binding.lblAtkEspP1.setText(String.valueOf(pokemon1.getAtkEsp()));
        ...
        binding.lblAtkP2.setText(String.valueOf(pokemon2.getAtk()));
        binding.lblAtkEspP2.setText(String.valueOf(pokemon2.getAtkEsp()));
        binding.lblHpP2.setText(String.valueOf(combateViewModel.vidaP2.getValue()));

        binding.btnAtkP1.setOnClickListener(l -> combateViewModel.combate(combateViewModel.vidaP2.getValue(), pokemon1.getAtk(), pokemon2.getDef()));

        binding.btnAtkEspP1.setOnClickListener(l -> combateViewModel.combate(combateViewModel.vidaP2.getValue(), pokemon1.getAtkEsp(), pokemon2.getDefEsp()));

        binding.btnAtkP2.setOnClickListener(l -> combateViewModel.combate(combateViewModel.vidaP1.getValue(), pokemon2.getAtk(), pokemon1.getDef()));

        binding.btnAtkEspP2.setOnClickListener(l -> combateViewModel.combate(combateViewModel.vidaP1.getValue(), pokemon2.getAtkEsp(), pokemon1.getDefEsp()));
        ...
        combateViewModel.ganador.observe(getViewLifecycleOwner(), ganador -> {
            ...
            message.append("Ataque: " + PokemonViewModel.listaPokemon.get(ganador - 1).getAtk() + "\n");
            message.append("Defensa: " + PokemonViewModel.listaPokemon.get(ganador - 1).getDef() + "\n");
            message.append("Ataque Especial: " + PokemonViewModel.listaPokemon.get(ganador - 1).getAtkEsp() + "\n");
            message.append("Defensa Especial: " + PokemonViewModel.listaPokemon.get(ganador - 1).getDefEsp() + "\n");
